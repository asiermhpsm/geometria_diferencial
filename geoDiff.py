...
def curvaturaGauss_pt_uv(parametrizacion, u, v, u0, v0, curv=None):
    """
...
def curvaturaGauss_pt_xyz(parametrizacion, u, v, x0, y0, z0, curv=None):
    """
    ...
    """
    u0, v0 = xyz_to_uv(parametrizacion, u, v, x0, y0, z0)
    return curvaturaGauss_pt_uv(parametrizacion, u, v, u0, v0, curv)
...
def curvaturaMedia_pt_uv(parametrizacion, u, v, u0, v0, curv=None):
    """
...
def curvaturaMedia_pt_xyz(parametrizacion, u, v, x0, y0, z0, curv=None):
    """
    ...
    """
    u0, v0 = xyz_to_uv(parametrizacion, u, v, x0, y0, z0)
    return curvaturaMedia_pt_uv(parametrizacion, u, v, u0, v0, curv)
...
def curvaturasPrincipales_pt_uv(parametrizacion, u, v, u0, v0, curv=None):
    """
    ...
    K_pt = curvaturaGauss_pt_uv(parametrizacion, u, v, u0, v0)
    H_pt = curvaturaMedia_pt_uv(parametrizacion, u, v, u0, v0)
    raiz = sp.sqrt(H_pt**2 - K_pt)
    return H_pt + raiz, H_pt - raiz

def curvaturasPrincipales_pt_xyz(parametrizacion, u, v, x0, y0, z0, curv=None):
    """
    ...
    """
    u0, v0 = xyz_to_uv(parametrizacion, u, v, x0, y0, z0)
    return curvaturasPrincipales_pt_uv(parametrizacion, u, v, u0, v0, curv)
